...
class PostPostingPage extends StatefulWidget {
  const PostPostingPage({
    super.key,
    this.community,
  });
  ...
  @override
  State<PostPostingPage> createState() => _PostPostingPageState();
}

class _PostPostingPageState extends State<PostPostingPage> {
  ...
  AppBar _buildAppBar() {
    return AppBar(
      ...
      actions: [
        BlocListener<PostFeedBloc, PostFeedState>(
          listener: (context, state) async {
            ...
            } else if (state is PostFeedFailure) {
              context.pop();
  ...
  void _postData() {
    ...
    sl<PostFeedBloc>().add(PostFeedEvent(postFeed: post));
  }
